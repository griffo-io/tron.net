namespace Tron.Net.Client
{
    ...
    public sealed class Wallet : IWallet
    {
        ...
        public async Task<NodeList> ListNodesAsync(CancellationToken token = default)
        {
        ...
        public async Task<Return> BroadcastTransactionAsync(Transaction transaction, CancellationToken token = default)
        {
            var wallet = GetWallet();
            return await wallet.BroadcastTransactionAsync(transaction, _configuration.GetCallOptions(token));
        }

        public async Task<Transaction> UpdateAccountAsync(AccountUpdateContract contract, CancellationToken token = default)
        {
            var wallet = GetWallet();
            return await wallet.UpdateAccountAsync(contract, _configuration.GetCallOptions(token));
        }

        public async Task<Transaction> VoteWitnessAccountAsync(VoteWitnessContract contract, CancellationToken token = default)
        {
            var wallet = GetWallet();
        ...
        public async Task<Transaction> CreateWitnessAsync(WitnessCreateContract contract, CancellationToken token = default)
        {
            var wallet = GetWallet();
        ...
        public async Task<Transaction> FreezeBalanceAsync(FreezeBalanceContract contract, CancellationToken token = default)
        {
            var wallet = GetWallet();
        ...
        public async Task<AssetIssueList> GetAssetIssueByAccountAsync(Account account, CancellationToken token = default)
        {
            var wallet = GetWallet();
            return await wallet.GetAssetIssueByAccountAsync(account, _configuration.GetCallOptions(token));
        }

        public async Task<AccountNetMessage> GetAccountNetAsync(Account account, CancellationToken token = default)
        {
            var wallet = GetWallet();
            return await wallet.GetAccountNetAsync(account, _configuration.GetCallOptions(token));
        }

        public async Task<AssetIssueContract> GetAssetIssueByNameAsync(BytesMessage message, CancellationToken token = default)
        {
            var wallet = GetWallet();
        ...
        public async Task<Block> GetBlockByIdAsync(BytesMessage message, CancellationToken token = default)
        {
            var wallet = GetWallet();
        ...
        public async Task<Transaction> GetTransactionByIdAsync(BytesMessage message, CancellationToken token = default)
        {
            var wallet = GetWallet();
        ...
        public async Task<NumberMessage> TotalTransactionAsync(CancellationToken token = default)
        {
            var wallet = GetWallet();
            return await wallet.TotalTransactionAsync(new EmptyMessage(), _configuration.GetCallOptions(token));
        }

        public async Task<NumberMessage> GetNextMaintenanceTimeAsync(CancellationToken token = default)
        {
            var wallet = GetWallet();
